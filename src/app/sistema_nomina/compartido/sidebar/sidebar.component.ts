  ...
  pintarMenu(){
    this.menuItems = [
      ...
      { path: '#', title: 'Procedimientos', icon: 'ni-app text-yellow', id:'rh_procesos', band: true, tipo : "collapse",
        submenu : [
          {path: 'procedimiento_contratacion', title: 'Aplicar solicitudes de Recursos Humanos', icon: 'ni-button-play text-yellow'},
          {path: 'procedimiento_contratacion', title: 'Captura de incidencias', icon: 'ni-ruler-pencil text-yellow'},
          {path: 'procedimiento_modificacion', title: 'Calculo de nómina', icon: 'ni-active-40 text-yellow'},
          {path: 'procedimiento_baja', title: 'Cierre de nómina', icon: 'ni-fat-remove text-yellow'},
        ]
      },
